...
const NavBar = () => {
  ...
  className={({ isActive }) =>
    [
      'relative flex items-center justify-center rounded-lg px-4 py-2 text-[10px] font-black uppercase tracking-[0.15em] transition-all italic border-2 overflow-hidden ml-4',
      isActive
        ? 'bg-[#3b4cca] text-white border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]'
        : 'bg-white text-zinc-900 border-zinc-900 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-0.5 hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] active:translate-y-0.5 active:shadow-none',
    ].join(' ')
  }
>
